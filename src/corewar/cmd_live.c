...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/12/11 19:38:12 by jpascal           #+#    #+#             */
/*   Updated: 2017/12/11 19:38:14 by jpascal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		live_in_arena(t_arena *arena, t_options *opts, int player_nb)
{
	...
	t_options *opts)
{
	...
	player_nb *= -1;
	arena->nb_lives += 1;
	live_in_arena(arena, opts, player_nb);
	proc->index = index;
}
